...
import image from "@/assets/images/IMG_5050.jpg"
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center">
                ...
                <p className="mx-auto mt-8 sm:max-w-2xl md:max-w-4xl text-balance text-md">
                  I truly cannot say enough amazing things about our day-of coordinator. From the moment she arrived at our ceremony and reception venue until the very end of the night, she was completely attentive, organized, and on top of every single detail.
                </p>
                ...
                <p className="mx-auto mt-8 sm:max-w-2xl md:max-w-4xl text-balance text-md">
                  She went above and beyond in every possible way, and I am beyond grateful for her. I have nothing but the very best things to say and would highly, highly recommend her to any bride-to-be. She is worth her weight in gold!
                </p>

                <h2 className="mx-auto mt-8 sm:max-w-2xl md:max-w-4xl text-balance text-4xl mb-10">
                  Sydney Fellerman and Chris Santos 
                </h2>
              </div>
            </div>
          </div>
