...
export default function FooterSection() {
    return (
        <footer className="md:py-6 bg-accent-foreground">
            <div className="mx-auto max-w-5xl px-6 flex flex-col md:flex-row items-center justify-between">
                <div className="flex-1 flex justify-center md:justify-start">
                    <Link
                        to="/"
                        aria-label="go home"
                        className="block size-fit">
                            <div className='shrink-0 w-16 aspect-square>'>
                                <Logo />
                            </div>
                    </Link>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center mt-6 md:mt-0 sm:-mb-2 md:mb-0 gap-1">
                    ...
                    <span className="text-primary sm:text-sm md:text-md font-medium">
                        Brand Your Day © {new Date().getFullYear()} All rights reserved.
                    </span>
                </div>
